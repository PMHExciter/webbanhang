<?php 
	trait ProductsModel{
		...
		public function modelUpdate($id){
			...
			$query->execute(["var_name"=>$name,"var_category_id"=>$category_id,"var_discount"=>$discount,"var_price"=>$price,"var_description"=>$description,"var_content"=>$content,"var_hot"=>$hot]);
		...
		public function modelCreate(){
			...
			//---			
			$query = $conn->prepare("insert into products set name=:var_name,category_id=:var_category_id,discount=:var_discount,price=:var_price,description=:var_description,content=:var_content,hot=:var_hot,photo=:var_photo");
			$query->execute(["var_name"=>$name,"var_category_id"=>$category_id,"var_discount"=>$discount,"var_price"=>$price,"var_description"=>$description,"var_content"=>$content,"var_hot"=>$hot,"var_photo"=>$photo]);	
		}
